...
function Strapi() {
  ...
  // Expose `koa` requirement (useful for tests)
  // and the main instance for generated apps.
  this.instance = require('koa');
  this.app = new Koa();
...
Strapi.prototype.instance = require('koa');
Strapi.prototype.app = new Koa();
